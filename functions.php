...
function loadup_scripts()
    {
        ...
        wp_enqueue_script( 'jquery.ajaxyjs', get_template_directory_uri() . '/js/script.js', array( 'jquery' ) );
        wp_enqueue_script( 'hamburger.js', get_template_directory_uri() . '/js/hamburger.js', array( 'jquery' ) );
    }
